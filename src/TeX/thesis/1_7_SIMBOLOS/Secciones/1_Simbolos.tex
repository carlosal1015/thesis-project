...
\begin{tabular}{L{1.5 cm}p{12.5 cm}}
    ...
    $C_{b}\left(\Omega\right)$              & Espacio de funciones continuas $\Omega\to\mathbb{R}$ y acotadas en $\Omega$.                 \\
    ...
    % $\mathcal{G}^{B}_{h}$                   & Puntos Para un dominio malla $\mathcal{G}$.                  \\
    % ${\left\|f\right\|}_{L^{p}\left(\Omega;\mathbb{C}\right)}$ & Norma $L^{p}$ con $p\in\left[1,\infty\right]$ de una función $f\colon\Omega\to\mathbb{C}$.   \\
\end{tabular}
