...
% \title{La selección de un esquema Upwind y Lax-Wendroff para la solución numérica de la ecuación advección-difusión}
% \title{Minimización del error en los métodos Upwind y Lax-Wendroff para la solución numérica de la ecuación advección-difusión}
\title{Estimación del Error en los Esquemas Upwind y Lax-Wendroff de la ecuación de Advección-Difusión lineal} % Evolutivos
%Título para CARÁTULA (Siempre en mayuscula y sin saltos de linea)
\titlecaratula{ESTIMACIÓN DEL ERROR EN LOS ESQUEMAS UPWIND Y LAX-WENDROFF DE LA ECUACIÓN DE ADVECCIÓN-DIFUSIÓN LINEAL} % EVOLUTIVOS
