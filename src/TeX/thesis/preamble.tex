...
\authorcaratula{
	Carlos Alonso Aznarán Laos\\[.5\baselineskip]
	\textcolor{orcidcolor}{\aiOrcid}
	\href{https://orcid.org/0000-0001-8314-2271}{0000-0001-8314-2271}
}
...
% Estimaciones de error del método de limitador pendiente para ecuaciones de advección-difusión lineal % de soluciones suaves
\title{Estimación del Error en los Esquemas de Alta Resolución de la ecuación de Advección-Difusión lineal}
...
% \titlecaratula{Estimación de error del método limitadora de flujo para problemas de advección-difusión lineal no estacionario} % EVOLUTIVOS
% \titlecaratula{Un esquema de diferencias finitas para resolver problemas de advección-difusión lineal no estacionario con la técnica del limitador de flujo}
\titlecaratula{Un esquema conservativo de diferencias de alta resolución para problemas de advección-difusión lineal} % no estacionario
...
\asesor{
	Dr. Jonathan Alfredo Munguía La Cotera\\[.5\baselineskip]
	\textcolor{orcidcolor}{\aiOrcid}
	\href{https://orcid.org/0000-0002-1237-286X}{0000-0002-1237-286X}
}

\asesorexterno{
	MSc. John Doe\\[.5\baselineskip]
	\textcolor{orcidcolor}{\aiOrcid}
